                    ...
                    <div class="login-content bg-white p-4 box-shadow">
                        ...
                        <form method="post" action="<?= base_url('Register/update_pass') ?>">
                            <div class="form-group ">
                                <input type="email" readonly class="form-control" name="email" value="<?= $this->uri->segment('3') ?>">


                                <input type="password" required class="form-control" name="password" placeholder="Masukan Password Baru">

                                <button type="submit" class="btn mag-btn m-2 ">Update Password</button>
