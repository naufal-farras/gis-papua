            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="dashboard/lokasi_detail" method="post">
                            ...
                            <div>
                                <button name="update" type="submit" class="btn btn-success">
                                    <i class="fa fa-save"></i>&nbsp; Tampilkan</button>



                                <a href="<?= base_url('dashboard/lokasi_baru') ?>" class="btn btn-primary btn-flat"><i class="fa fa-repeat"></i> Kembali</a>
